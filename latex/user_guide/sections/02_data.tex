...
\begin{lstlisting}
==================================================================
  CHGCAR ESTIMATE - Ag-Au-Pt space
==================================================================
...
It contains one compressed \file{CHGCAR} per material and nothing else --- no
\file{POSCAR}, \file{INCAR}, \file{POTCAR}, \file{OUTCAR} or \file{TAUCAR}.
...
\begin{description}
  ...
  \item[The valence charges are recoverable.] A pseudopotential \file{CHGCAR}
    ...
    space of any breadth over-determines them. On the Ag--Au--Pt set this
...
Measured on the Ag--Au--Pt set, the two constructions differ \emph{from each
