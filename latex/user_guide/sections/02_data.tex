...
The flat \file{chgcar/CHGCAR\_mp-124.gz} layout this replaces is still read,
and an archive already on disk in it still \emph{resumes} rather than
re-downloading --- so nothing has to be moved.
