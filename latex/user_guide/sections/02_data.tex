...
\begin{ptip}
\textbf{You do not need a modified VASP.} The external potential is computed
from \file{POSCAR}, \file{INCAR} and \file{POTCAR} using the tabulated
pseudopotential, reproducing a reference \file{EXTCAR} to a relative
