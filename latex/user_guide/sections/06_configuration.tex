...
\opt{early\_stopping} & \opt{50} & Stop after this many epochs without
...
With the shipped default \opt{valid\_fraction: 0.0}, early stopping is
therefore inactive. Set a split to use it.
\end{pwarn}
