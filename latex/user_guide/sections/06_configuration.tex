...
\opt{null} takes \opt{g\_max}, else $8.0$. \\
...
$1\,048\,576$ at \opt{width 16}, \opt{modes 8}, \opt{n\_radial 16}. Buy it back
with \opt{n\_radial} and \opt{width}, not with \opt{modes}.
