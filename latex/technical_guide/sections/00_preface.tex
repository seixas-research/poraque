...
\begin{description}
  ...
  \item[Chapter 6] Measured results on a platinum data set, with the analytic
...
\begin{itemize}
  ...
  \item \textbf{Hartree atomic units} in the analytical expressions of
    Chapters~1--2, where $\hbar = m_e = e = 1$ removes constants that would
    otherwise clutter every equation.
\end{itemize}
