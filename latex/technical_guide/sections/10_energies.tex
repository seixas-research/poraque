...
Across the twelve reference supercells the \emph{physically relevant} variation
of that total is $0.27$ eV/atom --- a relative $\sim10^{-4}$ of its own
...
Measured with the current models, evaluated on their own training
