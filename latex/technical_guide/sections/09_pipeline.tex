...
\file{models/poraque\_models.pth}, holding both operators under the keys
...
Measured on twelve gold structures: universal training fit gives relative
$L^2$ of $0.0059$ (\opt{ext2chg}) and $0.0128$ (\opt{chg2tau}), against
cross-validated values roughly four times larger. That gap is the memorisation
