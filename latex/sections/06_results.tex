...
Three gold structures, each a $3\times3\times3$ supercell of the face-centred
cubic primitive cell ($27$ atoms, $Z^{\mathrm{val}}=11$, so $297$ valence
electrons), computed with the modified VASP~6.2.0 of Chapter~\ref{ch:vasp} at
...
\begin{ptip}
All predicted fields are written in \file{CHGCAR} format and open directly in
VESTA. \opt{--compare} additionally brings reference files onto the prediction
...
measures \textbf{interpolation between nearby geometries of gold}. It
