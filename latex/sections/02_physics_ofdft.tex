...
Chapter~\ref{ch:results} measures these on gold. Thomas--Fermi achieves a
...
\begin{ptip}
This convention is why \file{EXTCAR} written by VASP has a cell average of
$-2.5\times10^{-12}$ eV, and why Poraqu\^e's reconstruction reproduces it to
$\sim10^{-16}$. Agreement of the mean was the first check that the two codes
share a convention, before any pointwise comparison was meaningful.
\end{ptip}
